...
<aside class="main-sidebar sidebar-light-primary elevation-4 bg-blue">
    ...
    <!-- Brand Logo -->
    <a href="<?php echo base_url()?>User/C_User" class="brand-link bg-blue">
      <img src="<?php echo base_url() ?>assets/dist/img/LogoLab.png" alt="Logo Labkom" class="brand-image img-circle elevation-3"
           style="opacity: .8">
