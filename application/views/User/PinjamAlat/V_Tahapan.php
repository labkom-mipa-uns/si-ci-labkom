        ...
        <section class="page-section mt-3">
            <div class="container mt-5">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Alur Peminjaman Alat</h2>
                    <h3 class="section-subheading text-muted">Laboratorium FMIPA UNS</h3>
                </div>
                <ul class="timeline">
                    <li>
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="<?php echo base_url() ?>assets/user/dist/assets/img/about/1.jpg" alt="" /></div>
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Cek Ketersedian Alat</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Untuk memastikan alat yang akan dipinjam tersedia atau tidak, bisa dilakukan via Chat atau langsung ke Ruang Pengelola  </p></div>
                        </div>
                    </li>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Mengisi formulir yang berkaitan dengan peminjaman alat, seperti data diri, nama alat, jumlah alat yang akan dipinjam dan lainya pada halaman ini</p></div>
                        </div>
                    </li>
